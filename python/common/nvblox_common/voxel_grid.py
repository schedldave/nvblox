...
class VoxelGrid:
    ...
    def __init__(self,
        ...
        """
        Construct an object representing an VoxelGrid.
    ...
    def voxel_centers_along_axis(self, axis_idx: int) -> np.ndarray:
        """
        Generate a ndarray of the voxel centers along a certain dimension.
    ...
    def create_from_sparse_mesh(mesh: o3d.geometry.TriangleMesh,
        ...
        This is performed by looking up the closest vertices on the input mesh.
    ...
    def num_valid_voxels(self) -> int:
        """
        Return the number of observed voxels.
